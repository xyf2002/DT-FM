...
# MoE-Infinity: replaced AsyncIOBuilder with BackendBuilder
...
class BackendBuilder(OpBuilder):
    ...
    def absolute_name(self):
        return f"morphling.ops.backend.{self.NAME}_op"
    ...
    def sources(self):
        return [
            ...
            "core/backend/archer_backend_handle.cpp",
            "core/backend/task_scheduler.cpp",
            "core/backend/task_thread.cpp",
            ...
            "core/python/py_archer_backend.cpp",
